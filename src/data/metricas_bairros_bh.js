...
export const BAIRROS_BH = [
  ...
  { key:'bh_bairro_buritis', label:'Buritis', zona:'Oeste',
    precoAnuncioM2:8369, precoContratoM2:7231, classeIpead:3, classeIpeadLabel:'Alto',
    yieldBruto:5.23, tendencia12m:6.9, rankingQA:8, tipoPreco:'supabase_2026-04',
    destaque_locacao:true, obs_locacao:'Dados calibrados AXIS abr/2026 — aluguel 3q R$30/m², 2q R$33/m²' },
  ...
  { key:'bh_bairro_silveira', label:'Silveira', zona:'Leste',
    precoAnuncioM2:7200, precoContratoM2:5904, classeIpead:3, classeIpeadLabel:'Alto',
    yieldBruto:6.30, tendencia12m:4.8, rankingQA:null, tipoPreco:'supabase_2026-04',
    obs_locacao:'Dados calibrados AXIS abr/2026 — aluguel 3q R$28/m², 2q R$31/m²' },
